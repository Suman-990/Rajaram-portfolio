...
const KeyAchievementsSection = () => {
  const items = [
    "Reduced manual reporting effort by 40% through automated dashboards",
    "Achieved 97% accuracy on a machine learning detection pipeline",
    "Saved 5+ hours per week with streamlined executive reporting",
    "Improved approval processing speed by 20% through workflow redesign",
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-muted-foreground max-w-xl mx-auto">Measurable outcomes that demonstrate impact and growth.</p>
          </div>
